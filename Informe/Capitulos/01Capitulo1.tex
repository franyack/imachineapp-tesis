...
\begin{itemize}
	...
	\item La aplicación fotos, perteneciente al sistema operativo Windows 10, permite buscar texto en las imágenes. La misma utiliza una tecnología denominada OCR\cite{ocr2007recognition} (reconocimiento óptico de caracteres), la cual permite detectar el lugar y la palabra misma, dentro de una imagen. 
