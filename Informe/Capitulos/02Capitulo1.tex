...
\begin{resumen}
En este capítulo se describe en primer lugar el diseño elegido para el sistema, explicando cada uno de sus componentes y justificando su composición. A continuación, se presenta la metodología de trabajo utilizada para llevar adelante el desarrollo de la aplicación. Luego, se explican las técnicas utilizadas tanto para la caracterización de las imágenes cómo para medir la similitud entre ellas. Después, se expone como fue aplicado el algoritmo MCL para obtener los grupos finales, y por último se presentan las herramientas con las que cuenta el usuario para administrar dicho resultado final.
\end{resumen}
