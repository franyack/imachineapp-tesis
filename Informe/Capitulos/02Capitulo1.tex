...
%-------------------------------------------------------------------
\section{[DONE] Diseño del sistema}
%-------------------------------------------------------------------
...
\subsection{[DONE] Patrón de programación seleccionado}
...
\section{[DONE] Motor de procesamiento de las imágenes}
