...
%-------------------------------------------------------------------
\subsubsection{[DONE]Redes neuronales}
%-------------------------------------------------------------------
...
Las ANNs son implementadas en computadoras, tanto en programas de software como en arquitecturas de hardware, para componer sistemas de aprendizaje maquinal. 

\begin{figure}[t]
	\begin{center}
		\includegraphics[width=0.7\textwidth]%
		{Imagenes/Bitmap/neuron_model}
		\caption{Modelo matemático de una neurona. Recuperado de \cite{learninspy2016tesis}}
...
\begin{figure}[t]
	\begin{center}
		...
		\caption{Arquitectura básica de un MLP con 4 capas. Recuperado de \cite{learninspy2016tesis}}
		\label{fig:mlp}
	\end{center}
\end{figure}
...
\subsubsection{[DONE] Aprendizaje Supervisado}
...
\begin{figure}[t]
	\begin{center}
		...
		{Imagenes/Bitmap/deepRepresentation3}
