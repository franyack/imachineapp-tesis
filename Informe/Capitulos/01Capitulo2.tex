...
En la siguiente sección, se realizará una introducción sobre conceptos relacionados a redes neuronales y aprendizaje profundo, rama que pertenece a la inteligencia artificial, la cual en el último tiempo estuvo tomando relevancia en el mundo informático gracias al constante avance que se logra en la resolución de problemas relacionados al reconocimiento e interpretación de imágenes.

%-------------------------------------------------------------------
\subsection{Comenzando con redes neuronales}
%-------------------------------------------------------------------
\label{cap2:subsec:introduccion-redes-profundas}
