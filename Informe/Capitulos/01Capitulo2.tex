...
%-------------------------------------------------------------------
\subsection{Comenzando con redes neuronales}
%-------------------------------------------------------------------
...
Las \textbf{RNA}s son implementadas en computadoras, tanto en programas de software como en arquitecturas de hardware, por lo cual se utilizan para componer un sistema de aprendizaje maquinal. No obstante, sólo consiste en una aproximación debido a que existen diferencias significativas con respecto a la manera que utiliza el cerebro humano para procesar la información que va adquiriendo. Si bien el término \textit{redes neuronales} está referenciado en la neurobiología y muchos conceptos son utilizados a modo de inspiración en la resolución de problemas, no existe evidencia de que el cerebro utilice mecanismos de aprendizajes como se usan en las técnicas implementadas con redes neuronales.
