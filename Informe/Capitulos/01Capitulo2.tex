...
%------------------------------------------------------------------
\subsection{Aplicaciones: actividades y ciclo de vida}
%-------------------------------------------------------------------
...
%-------------------------------------------------------------------
\section{Ingeligencia Artificial, Aprendizaje Maquinal y Aprendizaje Profundo}
%-------------------------------------------------------------------
...
Para comenzar, se debe definir claramente de que se está hablando cuando se menciona a la inteligencia artificial. ¿De qué se tratan los conceptos de inteligencia artificial (\textbf{AI}, del inglés \textit{``Artificial Intelligence''}), aprendizaje maquinal (\textbf{ML}, del inglés \textit{``Machine Learning''}) y aprendizaje profundo (\textbf{DL}, del inglés \textit{``Deep Learning''}) ¿Cómo están relacionados entre ellos? (ver Figura \ref{fig:ai-ml-dl})
...
La importancia de este proceso consiste en que, a medida que se entrena la red, las neuronas de las capas intermedias se organicen a sí mismas de tal modo que las neuronas aprenden a reconocer distintas características del espacio total de entrada. La meta es conseguir un modelo que pueda \underline{generalizar} a partir de los datos con los que fue entrenado, con el objetivo de no sobre-entrenarlo, y que sepa de ``memoria'' detalles de los datos de entrenamiento. Este fenómeno es conocido como \textit{overfitting}, donde se ve como el modelo reconoce toda la información relevante de los datos de entrenamiento, pero falla considerablemente cuando se le presentan nuevos datos.

Lo principal es que después del entrenamiento, cuando se les presente un patrón arbitrario de entrada que contenga ruido o que esté incompleto, las neuronas de la capa oculta de la red responderán con una salida activa si la nueva entrada contiene un patrón que se asemeje a aquella característica que las neuronas individuales hayan aprendido a reconocer durante su entrenamiento \cite{rojas2013neural}. 
