...
%-------------------------------------------------------------------
\section{[DONE] Ingeligencia Artificial, Aprendizaje Maquinal y Aprendizaje Profundo}
%-------------------------------------------------------------------
...
En esta sección, se realiza una introducción sobre conceptos relacionados a redes neuronales, aprendizaje maquinal y aprendizaje profundo, conceptos que pertenecen a la inteligencia artificial. El último de ellos, en particular, fue fundamental para la caracterización de las imágenes en este proyecto.
