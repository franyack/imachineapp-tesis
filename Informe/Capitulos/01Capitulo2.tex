...
Además, provee de un entorno de desarrollo integrado oficial (IDE), denominado \textit{Android Studio}. El mismo fue anunciado en mayo de 2013 y reemplazó a Eclipse como IDE oficial para el desarrollo de aplicaciones Android.

A continuación, se mencionan algunas de las características más destacables de la plataforma de desarrollo Android:
...
Cuando una actividad entra y sale de los diferentes estados que se describieron más arriba, esto se notifica a través de diferentes métodos \textit{callback}. En conjunto, estos métodos definen el ciclo de vida completo de una actividad, como se puede observar en la figura \ref{fig:activity-lifecycle}.
